...
public class SearchSellerServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//根据查询信息查询
		List<Seller> list=dao.getSearch(search);
		
		PrintWriter out = response.getWriter();
		out.println("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\">");
		out.println("<HTML>");
		out.println("<HEAD><TITLE>商家查询</TITLE></HEAD>");
		out.println("<body>");
		...
		out.println("<td width='210px'><b>图片</b></td><td><b>店铺编号</b></td><td><b>店名</b></td><td><b>店铺地址</b></td><td><b>运费</b></td><td><b>销量</b></td><td><b>操作</b></td>");
		out.println("</tr>");
		for(Seller s:list){
			out.println("<tr>");
			out.println("<td>");
			...
			out.println("<td>");
    		out.println("<a href='ListGoodsServlet?sid="+s.getSid()+"&&sellername="+s.getSellername()+"'>查看产品</a>");
			out.println("</td>");
			out.println("</tr>");
		}
